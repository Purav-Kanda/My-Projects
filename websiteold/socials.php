...
<body>
    ...
    <ul style="padding-left: 20px; line-height: 1.6;">
        <li>Launched a fully functional personal portfolio website independently.</li>
        <li>Built an AI-powered Campus Helper Bot using React with natural language processing for real-time student support.</li>
        <li>Developed a secure password manager using AES-256 encryption and PBKDF2.</li>
        <li>Created an interactive memory game available online.</li>
    </ul>
    <p class="text-muted" style="margin-top: 10px;">
        Updated: <?= $socialData['github_date'] ?>
    </p>
</div>
